...
//    timer2.start();
    ...
    if (sqlQuery.last() != false) {
        ...
        QList<qreal> dbValues = {sqlQuery.value(0).toReal(), sqlQuery.value(6).toReal(), sqlQuery.value(1).toReal(), sqlQuery.value(2).toReal(), sqlQuery.value(8).toReal(), sqlQuery.value(9).toReal(), sqlQuery.value(10).toReal(), -999, -999, -999, -999, sqlQuery.value(3).toReal(), sqlQuery.value(4).toReal(), -999, -999, sqlQuery.value(11).toReal(), sqlQuery.value(12).toReal(), sqlQuery.value(7).toReal(), sqlQuery.value(5).toReal()};

        emit updateSensorValues(dbValues[0], dbValues[1], dbValues[2], dbValues[3], dbValues[4], dbValues[5], dbValues[6], dbValues[7], dbValues[8], dbValues[9], dbValues[10], dbValues[11], dbValues[12], dbValues[13], dbValues[14], dbValues[15], dbValues[16], dbValues[17], dbValues[18], sqlQuery.value(15).toDateTime());
    } else {
        emit updateSensorValues(-999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, QDateTime::currentDateTime());
    }
...
//    timer.start();
    ...
    sqlStatement = "INSERT INTO rawSensorData ( raw_iat, raw_oat, raw_batteryVoltage, raw_current2, raw_current1, raw_manPressure, raw_fuelFlow, raw_fuelPressure, raw_cht2, raw_cht1, raw_oilPressure, \
        ...
        VALUES (" + QString::number(intTemp) + "," + QString::number(coolantT) + "," + QString::number(volts) + "," + QString::number(fuelL2) + "," + QString::number(curr) + "," + QString::number(fuelL1) + "," + QString::number(fuelFlow1) + "," + QString::number(fuelP) + "," + QString::number(ax2) + "," + QString::number(ax1) + "," + QString::number(oilP) + "," + QString::number(oilT) + "," + QString::number(rpm1) + "," + QString::number(intTemp) + "," + QString::number(oat) + "," + QString::number(volts) + "," + QString::number(current2) + "," + QString::number(current1) + "," + QString::number(manP) + "," + QString::number(fuelFlow) + "," + QString::number(fuelPress) + "," + QString::number(cht2) + "," + QString::number(cht1) + "," + QString::number(oilPress) + "," + QString::number(oilTemp) + "," + QString::number(rpm1) + ",'" + currentFlightTime+ "'," + QString::number(currentHobbs) + ",'" + QDateTime::currentDateTimeUtc().toString("yyyy-MM-dd hh:mm:ss.zzz") + "');";
