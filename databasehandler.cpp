...
//    timer2.start();
    ...
    if (sqlQuery.last() != false) {
        ...
        QList<qreal> dbValues = {sqlQuery.value(0).toReal(), sqlQuery.value(6).toReal(), sqlQuery.value(6).toReal(), sqlQuery.value(1).toReal(), sqlQuery.value(2).toReal(), sqlQuery.value(8).toReal(), sqlQuery.value(9).toReal(), sqlQuery.value(10).toReal(), -999, -999, -999, -999, sqlQuery.value(3).toReal(), sqlQuery.value(4).toReal(), -999, -999, sqlQuery.value(11).toReal(), sqlQuery.value(12).toReal(), sqlQuery.value(7).toReal(), sqlQuery.value(5).toReal()};
        ...
        emit updateSensorValues(-999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, -999, QDateTime::currentDateTime());
    }
