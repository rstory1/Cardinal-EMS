...
int main(int argc, char *argv[])
{
	...
	a.connect(&rdacConnect, SIGNAL(updateDataMessage2(double,double,double,double,double,double)), &engineMonitor, SLOT(setDataMessage2(double,double,double,double,double,double)));
